...
public interface FpgaModel {
	...
	/*
	 * // // SRAM // public void setTriggerChannel(DacTriggerId id, TriggerChannel
	 * ch); public Future<Void> deconvolveSram(DeconvolutionProxy deconvolver);
	 * 
	 * // // Memory // public void clearMemory(); public void
	 * addMemoryCommand(MemoryCommand cmd); public void
	 * addMemoryCommands(List<MemoryCommand> cmds); public void addMemoryNoop();
	 * public void addMemoryNoops(int n); public void addMemoryDelay(double
	 * microseconds);
	 * 
	 * 
	 ...
	 * 
	 * /** Check whether the timer is currently running (has been started but not
	 * yet stopped)
	 * 
	 * @return
	 *
	 ...
	 * 
	 * public void startTimer(); public void stopTimer();
	 * 
	 * public void callSramBlock(String blockName); public void
	 * callSramDualBlock(String block1, String block2); public void
	 * setSramDualBlockDelay(double delay); public boolean hasDualBlockSram();
	 * 
	 * // // bit sequences //
	 * 
