...
public class FastBiasCommands {
	public static SendFiberCommand get(BiasCommandType type, FastBiasChannel fb, double v) {
		...
		switch (type) {
		case DAC0:
			return setDac0(fb, vSend);
		case DAC0_NOSELECT:
			return setDac0NoSelect(fb, vSend);
		case DAC1:
			return setDac1Fast(fb, vSend);
		case DAC1_SLOW:
			return setDac1Slow(fb, vSend);
		default:
			throw new RuntimeException("Unknown bias command type: " + type);
		}
	}
