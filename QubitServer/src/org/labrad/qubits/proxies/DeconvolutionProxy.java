...
public class DeconvolutionProxy {
	...
	// TODO send requests in different contexts so that they can potentially be
	 ...
	 * @return
	 */
	public Future<int[]> deconvolveAnalog(DacBoard board, DacAnalogId id, double[] data, double[] settlingRates,
