...
public class ChannelBuilders {
	...
	public static ChannelBuilder fromData(Data template, Resources resources) {
		...
		switch (type) {
		case ANALOG:
			return new AnalogChannelBuilder(name, params, resources);
		case IQ:
			return new IqChannelBuilder(name, params, resources);
		case TRIGGER:
			return new TriggerChannelBuilder(name, params, resources);
		case FASTBIAS:
			return new FastBiasChannelBuilder(name, params, resources);
		case PREAMP:
			return new PreampChannelBuilder(name, params, resources);
		case ADC:
			return new AdcChannelBuilder(name, params, resources);
		default:
