...
public class Constants {
	 ...
	 * 
	 * This number is determined by two factors, first the number of reps must fit
	 * into a two byte field in the packet that is sent to the DACs, and second it
	 * must be a multiple of 30, since timing results are sent back in groups of 30.
	 */
	...
	// ([(Type, Name)...],[((GHz board id,chan),(DC board id,chan)),...],[(uwave
	// board id, microwave source id)])
