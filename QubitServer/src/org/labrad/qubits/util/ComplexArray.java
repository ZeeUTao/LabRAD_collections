 ...
 * because only two arrays need to be allocated, not one object per element in
 * the array. In addition, this class has convenience methods for converting to
 * and from LabRAD data.
 */
