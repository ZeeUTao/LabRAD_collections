...
public class Futures {
	/**
	 * Create from an existing Future a new Future that transforms the result using
	 * the given function.
	 * 
	 * @param      <F>
	 * @param      <T>
	...
	/**
	 * Create from an existing list of Futures a new Future that combines the
	 * results using the given function.
	 * 
	 * @param         <F>
	 * @param         <T>
	 * @param futures
	...
	/**
	 * Create from an existing list of Futures a new Future that waits for them all
